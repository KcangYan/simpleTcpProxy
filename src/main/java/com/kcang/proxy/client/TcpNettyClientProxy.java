...
import com.kcang.proxy.client.handler.ClientInnerChannelInboundHandler;
import com.kcang.proxy.client.handler.ClientProxyChannelInboundHandler;
...
public class TcpNettyClientProxy  {
    private String serverAddress;
    private int port;
    private Logger myLogger;
    private ChannelInitializer<SocketChannel> channelChannelInitializer;
    public TcpNettyClientProxy(String serverAddress, int port, Integer id){
        ...
        this.channelChannelInitializer = new ChannelInitializer<SocketChannel>(){
            ...
            protected void initChannel(SocketChannel ch) throws Exception {
                ch.pipeline().addLast(new ClientProxyChannelInboundHandler(id));
            }
        };
